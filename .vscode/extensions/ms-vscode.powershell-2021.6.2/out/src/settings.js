...
exports.change = exports.getEffectiveConfigurationTarget = exports.load = exports.CommentType = void 0;
...
(function (CommentType) {
    CommentType["Disabled"] = "Disabled";
    CommentType["BlockComment"] = "BlockComment";
    CommentType["LineComment"] = "LineComment";
...
function load() {
    ...
    const defaultNotebooksSettings = {
    ...
    return {
        ...
        helpCompletion: configuration.get("helpCompletion", CommentType.BlockComment),
        ...
        notebooks: configuration.get("notebooks", defaultNotebooksSettings),
        startAsLoginShell: 
        ...
        cwd: configuration.get("cwd", null),
    };
}
exports.load = load;
