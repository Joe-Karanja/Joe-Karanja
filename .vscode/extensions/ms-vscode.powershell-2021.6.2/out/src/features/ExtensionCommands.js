...
exports.ExtensionCommandsFeature = exports.ClearTerminalNotificationType = exports.SetStatusBarMessageRequestType = exports.ShowInformationMessageRequestType = exports.ShowWarningMessageRequestType = exports.ShowErrorMessageRequestType = exports.SaveFileRequestType = exports.CloseFileRequestType = exports.NewFileRequestType = exports.OpenFileRequestType = exports.SetSelectionRequestType = exports.InsertTextRequestType = exports.GetEditorContextRequestType = exports.ExtensionCommandAddedNotificationType = exports.InvokeExtensionCommandRequestType = void 0;
const fs = require("fs");
const os = require("os");
...
class ExtensionCommandsFeature extends languageClientConsumer_1.LanguageClientConsumer {
    constructor(log) {
        super();
        this.log = log;
        ...
        this.command3 = vscode.commands.registerCommand('PowerShell.ClosePanel', () => __awaiter(this, void 0, void 0, function* () { yield vscode.commands.executeCommand('workbench.action.closePanel'); })),
            this.command4 = vscode.commands.registerCommand('PowerShell.PositionPanelLeft', () => __awaiter(this, void 0, void 0, function* () { yield vscode.commands.executeCommand('workbench.action.positionPanelLeft'); })),
            this.command5 = vscode.commands.registerCommand('PowerShell.PositionPanelBottom', () => __awaiter(this, void 0, void 0, function* () { yield vscode.commands.executeCommand('workbench.action.positionPanelBottom'); })),
            this.command6 = vscode.commands.registerCommand('PowerShell.Debug.Start', () => __awaiter(this, void 0, void 0, function* () { yield vscode.commands.executeCommand('workbench.action.debug.start'); }));
    }
