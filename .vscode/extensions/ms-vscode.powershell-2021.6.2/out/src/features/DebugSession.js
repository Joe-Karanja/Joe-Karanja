...
class DebugSessionFeature extends languageClientConsumer_1.LanguageClientConsumer {
...
class PickPSHostProcessFeature extends languageClientConsumer_1.LanguageClientConsumer {
    constructor() {
        super();
        this.command =
    ...
    pickPSHostProcess() {
        return this.languageClient.sendRequest(exports.GetPSHostProcessesRequestType, {}).then((hostProcesses) => {
...
class PickRunspaceFeature extends languageClientConsumer_1.LanguageClientConsumer {
    constructor() {
        super();
        this.command =
