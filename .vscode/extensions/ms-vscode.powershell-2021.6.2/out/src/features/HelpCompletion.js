...
exports.HelpCompletionFeature = exports.CommentHelpRequestType = void 0;
...
class HelpCompletionFeature extends languageClientConsumer_1.LanguageClientConsumer {
    constructor(log) {
        super();
        this.log = log;
