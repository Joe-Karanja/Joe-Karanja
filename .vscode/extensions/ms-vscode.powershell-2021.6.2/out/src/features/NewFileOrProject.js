...
exports.NewProjectFromTemplateRequestType = exports.GetProjectTemplatesRequestType = exports.NewFileOrProjectFeature = void 0;
const vscode = require("vscode");
const vscode_languageclient_1 = require("vscode-languageclient");
const languageClientConsumer_1 = require("../languageClientConsumer");
class NewFileOrProjectFeature extends languageClientConsumer_1.LanguageClientConsumer {
    constructor() {
        super();
        this.loadIcon = "  $(sync)  ";
        this.command =
